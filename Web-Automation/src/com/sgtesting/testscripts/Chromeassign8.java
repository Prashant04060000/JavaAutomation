...
public class Chromeassign8 {
   ...
   static void  modifytask()
   {
	   try
	   {
		   ...
		   Thread.sleep(2000);
		   oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[3]/div[2]/div[1]/div[2]/div[3]/div[2]/div/div[1]/textarea")).sendKeys("Need to struggle hard");
		   Thread.sleep(2000);
		   oBrowser.findElement(By.xpath("//*[@id=\'taskListBlock\']/div[3]/div[2]/div[1]/div[2]/div[1]/div[2]/div[2]/div[2]/div/span[2]")).sendKeys("ReachTheGoal");
		   Thread.sleep(2000);
		   oBrowser.findElement(By.xpath("//*[@id=\'ext-gen333\']/span[2]")).click();
		   Thread.sleep(2000);
		   oBrowser.findElement(By.xpath("//*[@id=\'ext-gen309\']")).click();
		   Thread.sleep(2000);
		  // oBrowser.findElement(By.xpath("")).click();
		  // Thread.sleep(2000);
	   }catch(Exception e)
